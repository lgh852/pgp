    ...
    <div style="margin: 0 auto; right: 1250px; top: 10px; position: absolute;">
		...
		<div class="border-bottom"
			...
			<div
				...
				<a class="py-2 d-none d-md-inline-block fontcolor"
					href="<%=request.getContextPath()%>/manager/noticelist">공지 사항</a> <a
					...
					class="py-2 d-none d-md-inline-block fontcolor"
					href="<%=request.getContextPath()%>/manager/noticeinsert">공지사항</a>
					...
					href="<%=request.getContextPath()%>/manager/noticeinsert">
							공지사항 입력하기</a> <a
					class="py-2 d-none d-md-inline-block fontcolor"
					href="<%=request.getContextPath()%>/manager/faqinsert">
							FAQ 입력하기</a>
				</c:if>
			</div>
