...
<div class="imgcenter" style="margin: 0 auto">
	...
	<div id="imgbox" class="border"
		...
		<c:forEach items="${urlList}" var="urlList" end="5" begin="0"
			varStatus="status">

			<c:if test="${urlList.tag_idx!=null}">

				<div id="viewbox" class="check${status.count} block"
					data-toggle="modal" data-target="#exampleModal"<%-- style="left: ${urlList.tag_position_x}px;    position:absolute; top:${urlList.tag_position_y}px;" --%>>
					<a href="#" class="aclick${status.count} " data-toggle="modal"
			...
			<c:if test="${urlList.tag_idx==null||urlList==null}">
				<div id="viewbox" class="check${status.count} none"
	...
	<div id="serchbutton" class="serchbox none">
		...
		<input type="hidden" id="hidden_board_idx" value="${board_idx}"
			...
			<div id="viewbox" class="check2 none"
					data-toggle="modal" data-target="#exampleModal"<%-- style="left: ${urlList.tag_position_x}px;    position:absolute; top:${urlList.tag_position_y}px;" --%>>
					<a href="#" class="aclick " data-toggle="modal"
						data-target="#exampleModal"> <img class="check2"
						src="<%=request.getContextPath()%>/resources/images/plus.png"
						alt="" width="40px" height="40px"style="position: absolute"
						>
					</a>
				</div>
				...
				<div id="viewbox" class="check3 none"
					data-toggle="modal" data-target="#exampleModal"<%-- style="left: ${urlList.tag_position_x}px;    position:absolute; top:${urlList.tag_position_y}px;" --%>>
					<a href="#" class="aclick " data-toggle="modal"
						data-target="#exampleModal"> <img class="check3"
						src="<%=request.getContextPath()%>/resources/images/plus.png"
						alt="" width="40px" height="40px"style="position: absolute"
						>
					</a>
				...
				<div id="viewbox" class="check4 none"
					data-toggle="modal" data-target="#exampleModal"<%-- style="left: ${urlList.tag_position_x}px;    position:absolute; top:${urlList.tag_position_y}px;" --%>>
					<a href="#" class="aclick " data-toggle="modal"
						data-target="#exampleModal"> <img class="check4"
						src="<%=request.getContextPath()%>/resources/images/plus.png"
						alt="" width="40px" height="40px" style="position: absolute"
						>
					</a>
				</div>
				<div id="viewbox" class="none check1"
					data-toggle="modal" data-target="#exampleModal"<%-- style="left: ${urlList.tag_position_x}px;    position:absolute; top:${urlList.tag_position_y}px;" --%>>
					<a href="#" class="aclick " data-toggle="modal"
						data-target="#exampleModal"> <img class="check1 "
						src="<%=request.getContextPath()%>/resources/images/plus.png"
						alt="" width="40px" height="40px" style="position: absolute"
						>
					</a>
				</div>
				<div id="viewbox" class="none check5"
					data-toggle="modal" data-target="#exampleModal"<%-- style="left: ${urlList.tag_position_x}px;    position:absolute; top:${urlList.tag_position_y}px;" --%>>
					<a href="#" class="aclick " data-toggle="modal"
						data-target="#exampleModal"> <img class="check5"
						src="<%=request.getContextPath()%>/resources/images/plus.png"
						alt="" width="40px" height="40px" style="position: absolute"
						>
					</a>
