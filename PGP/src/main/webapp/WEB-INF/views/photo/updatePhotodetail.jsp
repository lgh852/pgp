...
<div style="margin: 0 auto;width: 100%">
         ...
         <img width="100%" height="100%" id="imgPre" src="<%=request.getContextPath()%>/resources/BoardPhoto/${photoName}"  style=" max-height: 600px;min-height: 600px;margin: 0 auto;"  class="border-0 img-thumbnail">
            </div>
        </div>
  ...
  <div class="row " style="margin-top: 10px" >
    <div class="col">
        ...
        <input type="hidden" class="room" value="${roomno}">
        <input type="hidden" class="space" value="${spaceno}">
  ...
  <input type="text"  name="board_title" class="form-control" aria-label="Default"  value="${board.board_title}"aria-describedby="inputGroup-sizing-default">
</div>
            <div >
    ...
    <div class="col">
      ...
      <script>
      	$(document).ready(function(){
      		...
      		$("#inputGroupSelect02 option").each(function() {

				if ($(this).val() == $('.room').val()) {
